          ...
          <div v-if="app.subApps && openDropdown === app.id" class="absolute top-full left-0 right-0 mt-2 z-20"
            ...
            <div class="bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden animate-scale-in">
              ...
              <div class="py-2 max-h-64 overflow-y-auto">
                <a v-for="subApp in app.subApps" :key="subApp.id" :href="subApp.url" target="_blank"
                  rel="noopener noreferrer" @click="handleSubAppClick(subApp)"
    ...
    subApps: [
      {
        ...
        description: 'Datos y perfiles de empleados',
        icon: UserCheckIcon,
        color: '#3B82F6',
        url: 'https://rh-personal.empresa.com'
      },
      {
        id: 12,
        ...
        icon: CalendarIcon,
        color: '#10B981',
        url: 'https://rh-permisos.empresa.com'
      },
      {
        id: 13,
        title: 'Evaluaciones',
        description: 'Desempeño y competencias',
        icon: ClipboardListIcon,
        color: '#F59E0B',
        url: 'https://rh-evaluaciones.empresa.com'
      },
      {
        id: 14,
        title: 'Nómina',
        description: 'Pagos y beneficios',
        icon: DollarSignIcon,
        color: '#EF4444',
        url: 'https://rh-nomina.empresa.com'
      }
    ]
  },
  {
    id: 2,
    title: 'Inventarios',
    description: 'Control financiero y contabilidad empresarial',
    icon: BarChart3Icon,
    color: '#10B981',
    ...
    subApps: [
      {
        ...
        icon: FileTextIcon,
        color: '#10B981',
        url: 'https://finanzas-contabilidad.empresa.com'
      },
      {
        id: 22,
        title: 'Presupuestos',
        ...
        icon: TrendingUpIcon,
        color: '#3B82F6',
        url: 'https://finanzas-presupuestos.empresa.com'
      },
      {
        id: 23,
        title: 'Reportes',
        ...
        icon: PieChartIcon,
        color: '#8B5CF6',
        url: 'https://finanzas-reportes.empresa.com'
      }
    ]
  },
  {
    ...
    url: 'https://documentos.empresa.com' // App sin submenú
  },
  {
    id: 4,
    title: 'Biblioteca',
    ...
    subApps: [
      {
        ...
        color: '#EF4444',
        url: 'https://config-seguridad.empresa.com'
      },
      {
        id: 42,
        title: 'Base de Datos',
        ...
        icon: DatabaseIcon,
        color: '#6B7280',
        url: 'https://config-database.empresa.com'
      }
    ]
  }
])
