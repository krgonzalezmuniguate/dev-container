...
use App\Services\Supplies\ProviderService;
...
class ProviderController extends Controller
{
    ...
    public function __construct(PdfService $pdfService, QrCodeService $qrService, ProviderService $Service, IndexResponder $IndexResponder, StoreResponder $StoreResponder, UpdateResponder $UpdateResponder, DeleteResponder $DeleteResponder, ShowResponder $ShowResponder, MailServiceInterface $mailService)
    {
